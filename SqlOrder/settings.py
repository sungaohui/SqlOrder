"""
Django settings for SqlOrder project.
...
SECRET_KEY = 'f%93#(z_rq#yap2y$^m!e#(0-+&nsvc1su5n2=k2#$&k8*2p0e'
...
WSGI_APPLICATION = 'SqlOrder.wsgi.application'
